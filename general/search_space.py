from general.utils import extract_items, extract_l_max, read_data_kosarak, read_data_sc2, read_data, read_jmlr
...
if __name__ == '__main__':
    datasets = [
        ...
        (read_data_kosarak('../data/figures_rc.dat'), '1', 'RocketLeague')
    ]
    ...
    for dataset in datasets:
        ...
        print('{:.2E}'.format(Decimal(pattern_number_2)))
